...
if df is not None:
    ...
    fig_co_network_all = npt.build_graph(words, min_edge_frequency=min_edge_frequency_all)
    ...
    for name, group in grouped:
        ...
        fig_co_network_group = npt.build_graph(words_group, min_edge_frequency=min_edge_frequency_group)
